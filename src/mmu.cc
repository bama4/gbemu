...
MMU::MMU(Gameboy &inGb, Options &inOptions) : gb(inGb), options(inOptions) {
...
auto MMU::read_io(const Address &address) const -> u8 {
    ...
    case 0xFF10:
        return gb.audio.channel_one_sweep.value();

    case 0xFF11:
        return gb.audio.channel_one_duty.value();
    case 0xFF12:
        return gb.audio.channel_one_envelope.value();
    case 0xFF13:
        return gb.audio.channel_one_freq_lo.value();
    case 0xFF14:
        return gb.audio.channel_one_freq_hi.value();
    ...
    case 0xFF16:
        return gb.audio.channel_two_duty.value();
    case 0xFF17:
        return gb.audio.channel_two_envelope.value();
    case 0xFF18:
        return gb.audio.channel_two_freq_lo.value();
    case 0xFF19:
        return gb.audio.channel_two_freq_hi.value();

    /* TODO: Audio - Channel 3: Wave Output */
    case 0xFF1A:
        return gb.audio.channel_three_switch.value();
    case 0xFF1B:
        return gb.audio.channel_three_length.value();
    case 0xFF1C:
        return gb.audio.channel_three_level.value();
    case 0xFF1D:
        return gb.audio.channel_three_freq_lo.value();
    case 0xFF1E:
        return gb.audio.channel_three_freq_hi.value();
    case 0xFF1F:
        return unmapped_io_read(address);

    /* TODO: Audio - Channel 4: Noise */
    case 0xFF20:
        return gb.audio.channel_four_length.value();
    case 0xFF21:
        return gb.audio.channel_four_envelope.value();
    case 0xFF22:
        return gb.audio.channel_four_poly_ctr.value();
    case 0xFF23:
        return gb.audio.channel_four_init.value();

    /* TODO: Audio - Channel control/ON-OFF/Volume */
    case 0xFF24:
        return gb.audio.channel_ctrl.value();

    /* TODO: Audio - Selection of sound output terminal */
    case 0xFF25:
        return gb.audio.select_terminal.value();

    /* TODO: Audio - Sound on/off */
    case 0xFF26:
        return gb.audio.sound_switch.value();
    ...
    case 0xFF3E:
    case 0xFF3F:
        return gb.audio.read(address - 0xFF30);
    ...
    case 0xFF46:
        log_warn("Attempted to read from write-only DMA Transfer/Start Address "
                 "(0xFF46)");
        return 0xFF;
    ...
    case 0xFF68:
        log_unimplemented(
            "Attempted to read from CGB background color palette spec/index");
        return 0xFF;
    ...
    case 0xFF6A:
        log_unimplemented(
            "Attempted to read from CGB OBJ color palette spec/index");
        return 0xFF;
...
void MMU::write_io(const Address &address, const u8 byte) {
    ...
    case 0xFF68:
        log_unimplemented(
            "Attempted to write to CGB background color palette spec/index");
        return;
    ...
    case 0xFF6A:
        log_unimplemented(
            "Attempted to write to CGB OBJ color palette spec/index");
        return;
...
void MMU::unmapped_io_write(const Address &address, const u8 byte) {
    log_warn("Attempting to write to unused IO address 0x%x - 0x%x",
             address.value(), byte);
}
